...
export enum $Node {
  ...
  ITEM_DOCUMENTATION = 'ITEM_DOCUMENTATION HIDDEN SYNTAX NODE',
  DESCRIPTION_DOCUMENTATION = 'DESCRIPTION_DOCUMENTATION HIDDEN TOKEN NODE',
  LABEL_DOCUMENTATION = 'DOCUMENTATION_LABEL HIDDEN TOKEN NODE',
  OPEN_DOCUMENTATION = 'DOCUMENTATION_OPEN HIDDEN TOKEN NODE',
  CLOSE_DOCUMENTATION = 'DOCUMENTATION_CLOSE HIDDEN TOKEN NODE',
