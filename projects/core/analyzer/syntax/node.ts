...
export enum $Node {
  ...
  DOCUMENTATION_ITEM = 'DOCUMENTATION_ITEM SYNTAX NODE',
  DOCUMENTATION_DESCRIPTION = 'DOCUMENTATION_DESCRIPTION TOKEN NODE',
  DOCUMENTATION_LABEL = 'DOCUMENTATION_LABEL TOKEN NODE',
  DOCUMENTATION_OPEN = 'DOCUMENTATION_OPEN TOKEN NODE',
  DOCUMENTATION_CLOSE = 'DOCUMENTATION_CLOSE TOKEN NODE',
