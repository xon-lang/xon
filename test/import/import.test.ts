...
import { PrefixExpressionTree } from '~/tree/prefix/prefix-expression-tree';
...
test('import', () => {
  ...
  const statement = tree.expressions[0] as DeclarationStatementTree;
  ...
  const statement2 = tree.expressions[1] as DeclarationStatementTree;
