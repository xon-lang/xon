...
import { DeclarationStatementNode } from './declaration/declaration-statement-node';
...
export const getStatementNode = (ctx: StatementContext): StatementNode => {
  ...
  if (ctx instanceof DeclarationStatementContext) return new DeclarationStatementNode(ctx);
