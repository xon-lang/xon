...
test('multiple parameters array value', () => {
  ...
  expect(
    scope
      .find('a')
      .type()
      .equals(new LiteralTypeMetadata(1, () => scope.core.integer)),
  ).toBe(true);
  ...
  expect(
    scope
      .find('b')
      .type()
      .equals(new LiteralTypeMetadata('hi', () => scope.core.string)),
  ).toBe(true);
  ...
  expect(
    scope
      .find('c')
      .type()
      .equals(new LiteralTypeMetadata(2.3, () => scope.core.float)),
  ).toBe(true);
});
