import { parseSource, parseSourceFile } from '~/analysis/syntax/syntax-analysis';
...
test('2.xon', () => {
  ...
  const declarationTree = tree.nodes[0] as DeclarationStatementTree.declaration as DeclarationTree;
