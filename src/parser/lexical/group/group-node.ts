...
import { CloseNode } from '~/parser/lexical/close/close-node';
import { CommaNode } from '~/parser/lexical/comma/comma-node';
import { SyntacticNode } from '~/parser/lexical/lexical-node';
import { NodeType } from '~/parser/lexical/node';
import { OpenNode, scanOpenNode } from '~/parser/lexical/open/open-node';
