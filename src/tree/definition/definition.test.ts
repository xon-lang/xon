...
testXonFIle(DefinitionTree, (tree) => {
    ...
    expect(tree.properties[0].valueType).toBe('str');
    expect(tree.properties[0].value).toBeUndefined();
    expect(tree.properties[1].name).toBe('anotherProp');
    expect(tree.properties[1].valueType).toBeUndefined();
    ...
    expect(tree.methods[1].args[0].valueType).toBe('num');
    expect(tree.methods[1].args[0].value).toBeUndefined();
    expect(tree.methods[1].args[1].name).toBe('y');
    expect(tree.methods[1].args[1].valueType).toBe('num');
