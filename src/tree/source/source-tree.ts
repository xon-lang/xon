...
export class SourceTree extends Tree {
  ...
  toString(): String {
    ...
    result = [uniqueImportStatements, otherStatements, attributes, definitions]
      .filter((x) => x)
      .join('\n\n');
