...
export class XonParser extends Parser {
	...
	public source(): SourceContext {
		...
		try {
			...
			while (((((_la - 3)) & ~0x1F) === 0 && ((1 << (_la - 3)) & ((1 << (XonParser.OPEN_BRACKET - 3)) | (1 << (XonParser.OPEN_PAREN - 3)) | (1 << (XonParser.OPEN_BRACE - 3)) | (1 << (XonParser.ACTUAL - 3)) | (1 << (XonParser.BREAK - 3)) | (1 << (XonParser.CONTINUE - 3)) | (1 << (XonParser.DO - 3)) | (1 << (XonParser.EXPORT - 3)) | (1 << (XonParser.FOR - 3)) | (1 << (XonParser.IF - 3)) | (1 << (XonParser.IMPORT - 3)) | (1 << (XonParser.RETURN - 3)) | (1 << (XonParser.WHILE - 3)) | (1 << (XonParser.GENERIC_LEFT - 3)) | (1 << (XonParser.FLOAT_LITERAL - 3)) | (1 << (XonParser.INTEGER_LITERAL - 3)) | (1 << (XonParser.STRING_LITERAL - 3)) | (1 << (XonParser.PREPROCESSOR - 3)) | (1 << (XonParser.ID - 3)) | (1 << (XonParser.OPERATOR - 3)) | (1 << (XonParser.NL - 3)))) !== 0)) {
				{
				this.state = 27;
				this._errHandler.sync(this);
	...
	public expr(_p?: number): ExprContext {
		...
		try {
			...
			case 2:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (((((_la - 3)) & ~0x1F) === 0 && ((1 << (_la - 3)) & ((1 << (XonParser.OPEN_BRACKET - 3)) | (1 << (XonParser.OPEN_PAREN - 3)) | (1 << (XonParser.OPEN_BRACE - 3)) | (1 << (XonParser.GENERIC_LEFT - 3)) | (1 << (XonParser.FLOAT_LITERAL - 3)) | (1 << (XonParser.INTEGER_LITERAL - 3)) | (1 << (XonParser.STRING_LITERAL - 3)) | (1 << (XonParser.PREPROCESSOR - 3)) | (1 << (XonParser.ID - 3)) | (1 << (XonParser.OPERATOR - 3)))) !== 0)) {
					{
					this.state = 154;
					this.arrayItem();
					this.state = 159;
	...
	public static readonly _serializedATN: string =
		...
		"\x06\x05\x06\xC3\n\x06\x03\x06\x03\x06\x03\x06\x05\x06\xC8\n\x06\x03\x06" +
		"\x03\x06\x05\x06\xCC\n\x06\x03\x06\x03\x06\x03\x06\x03\x06\x03\x06\x03" +
		"\x06\x05\x06\xD4\n\x06\x03\x06\x03\x06\x03\x06\x03\x06\x03\x06\x03\x06" +
		"\x03\x06\x03\x06\x07\x06\xDE\n\x06\f\x06\x0E\x06\xE1\v\x06\x03\x06\x05" +
		"\x06\xE4\n\x06\x05\x06\xE6\n\x06\x03\x06\x03\x06\x03\x06\x03\x06\x03\x06" +
		"\x03\x06\x07\x06\xEE\n\x06\f\x06\x0E\x06\xF1\v\x06\x03\x06\x05\x06\xF4" +
		"\n\x06\x05\x06\xF6\n\x06\x03\x06\x03\x06\x03\x06\x03\x06\x03\x06\x03\x06" +
		"\x03\x06\x03\x06\x07\x06\u0100\n\x06\f\x06\x0E\x06\u0103\v\x06\x03\x07" +
		"\x03\x07\x03\x07\x05\x07\u0108\n\x07\x03\b\x03\b\x03\b\x03\b\x03\b\x03" +
		"\b\x06\b\u0110\n\b\r\b\x0E\b\u0111\x03\b\x05\b\u0115\n\b\x03\t\x03\t\x03" +
		"\t\x05\t\u011A\n\t\x03\t\x03\t\x03\n\x03\n\x03\n\x03\n\x03\n\x03\n\x05" +
		"\n\u0124\n\n\x03\v\x03\v\x03\v\x03\v\x07\v\u012A\n\v\f\v\x0E\v\u012D\v" +
		"\v\x03\v\x05\v\u0130\n\v\x05\v\u0132\n\v\x03\v\x03\v\x03\f\x03\f\x03\f" +
		"\x03\f\x07\f\u013A\n\f\f\f\x0E\f\u013D\v\f\x03\f\x05\f\u0140\n\f\x05\f" +
		"\u0142\n\f\x03\f\x03\f\x03\r\x03\r\x03\r\x03\r\x07\r\u014A\n\r\f\r\x0E" +
		"\r\u014D\v\r\x03\r\x05\r\u0150\n\r\x03\r\x03\r\x03\r\x02\x02\x03\n\x0E" +
		"\x02\x02\x04\x02\x06\x02\b\x02\n\x02\f\x02\x0E\x02\x10\x02\x12\x02\x14" +
		"\x02\x16\x02\x18\x02\x02\x03\x03\x02\"#\x02\u019A\x02\x1F\x03\x02\x02" +
		"\x02\x04\"\x03\x02\x02\x02\x06Q\x03\x02\x02\x02\b\x97\x03\x02\x02\x02" +
		"\n\xD3\x03\x02\x02\x02\f\u0107\x03\x02\x02\x02\x0E\u0114\x03\x02\x02\x02" +
		"\x10\u0119\x03\x02\x02\x02\x12\u011D\x03\x02\x02\x02\x14\u0125\x03\x02" +
		"\x02\x02\x16\u0135\x03\x02\x02\x02\x18\u0145\x03\x02\x02\x02\x1A\x1E\x05" +
		"\x04\x03\x02\x1B\x1E\x05\b\x05\x02\x1C\x1E\x07$\x02\x02\x1D\x1A\x03\x02" +
		"\x02\x02\x1D\x1B\x03\x02\x02\x02\x1D\x1C\x03\x02\x02\x02\x1E!\x03\x02" +
		"\x02\x02\x1F\x1D\x03\x02\x02\x02\x1F \x03\x02\x02\x02 \x03\x03\x02\x02" +
		"\x02!\x1F\x03\x02\x02\x02\"#\x07\"\x02\x02#%\x07\"\x02\x02$&\x05\x18\r" +
		"\x02%$\x03\x02\x02\x02%&\x03\x02\x02\x02&(\x03\x02\x02\x02\')\x05\x14" +
		"\v\x02(\'\x03\x02\x02\x02()\x03\x02\x02\x02)+\x03\x02\x02\x02*,\x05\n" +
		...
		"\t\x03\x02\x02\x02\x99\x9A\b\x06\x01\x02\x9A\xD4\x07!\x02\x02\x9B\xA7" +
		...
		"\x03\x02\x02\x02\xA8\xA9\x03\x02\x02\x02\xA9\xD4\x07\x06\x02\x02\xAA\xB6" +
		...
		"\x03\x02\x02\x02\xB7\xB8\x03\x02\x02\x02\xB8\xD4\x07\n\x02\x02\xB9\xD4" +
		"\x05\f\x07\x02\xBA\xBB\x07#\x02\x02\xBB\xD4\x05\n\x06\b\xBC\xD4\x07\"" +
		"\x02\x02\xBD\xBF\x05\x18\r\x02\xBE\xBD\x03\x02\x02\x02\xBE\xBF\x03\x02" +
		"\x02\x02\xBF\xC0\x03\x02\x02\x02\xC0\xC2\x05\x14\v\x02\xC1\xC3\x05\n\x06" +
		"\x02\xC2\xC1\x03\x02\x02\x02\xC2\xC3\x03\x02\x02\x02\xC3\xC4\x03\x02\x02" +
		"\x02\xC4\xC5\x05\x0E\b\x02\xC5\xD4\x03\x02\x02\x02\xC6\xC8\x05\x18\r\x02" +
		"\xC7\xC6\x03\x02\x02\x02\xC7\xC8\x03\x02\x02\x02\xC8\xC9\x03\x02\x02\x02" +
		"\xC9\xCB\x05\x16\f\x02\xCA\xCC\x05\n\x06\x02\xCB\xCA\x03\x02\x02\x02\xCB" +
		"\xCC\x03\x02\x02\x02\xCC\xCD\x03\x02\x02\x02\xCD\xCE\x05\x0E\b\x02\xCE" +
		"\xD4\x03\x02\x02\x02\xCF\xD0\x07\x07\x02\x02\xD0\xD1\x05\n\x06\x02\xD1" +
		"\xD2\x07\b\x02\x02\xD2\xD4\x03\x02\x02\x02\xD3\x99\x03\x02\x02\x02\xD3" +
		"\x9B\x03\x02\x02\x02\xD3\xAA\x03\x02\x02\x02\xD3\xB9\x03\x02\x02\x02\xD3" +
		"\xBA\x03\x02\x02\x02\xD3\xBC\x03\x02\x02\x02\xD3\xBE\x03\x02\x02\x02\xD3" +
		"\xC7\x03\x02\x02\x02\xD3\xCF\x03\x02\x02\x02\xD4\u0101\x03\x02\x02\x02" +
		"\xD5\xD6\f\x07\x02\x02\xD6\xD7\t\x02\x02\x02\xD7\u0100\x05\n\x06\b\xD8" +
		"\xD9\f\x0E\x02\x02\xD9\xE5\x07\x07\x02\x02\xDA\xDF\x05\n\x06\x02\xDB\xDC" +
		"\x07\x19\x02\x02\xDC\xDE\x05\n\x06\x02\xDD\xDB\x03\x02\x02\x02\xDE\xE1" +
		"\x03\x02\x02\x02\xDF\xDD\x03\x02\x02\x02\xDF\xE0\x03\x02\x02\x02\xE0\xE3" +
		"\x03\x02\x02\x02\xE1\xDF\x03\x02\x02\x02\xE2\xE4\x07\x19\x02\x02\xE3\xE2" +
		"\x03\x02\x02\x02\xE3\xE4\x03\x02\x02\x02\xE4\xE6\x03\x02\x02\x02\xE5\xDA" +
		"\x03\x02\x02\x02\xE5\xE6\x03\x02\x02\x02\xE6\xE7\x03\x02\x02\x02\xE7\u0100" +
		"\x07\b\x02\x02\xE8\xE9\f\r\x02\x02\xE9\xF5\x07\x05\x02\x02\xEA\xEF\x05" +
		"\n\x06\x02\xEB\xEC\x07\x19\x02\x02\xEC\xEE\x05\n\x06\x02\xED\xEB\x03\x02" +
		"\x02\x02\xEE\xF1\x03\x02\x02\x02\xEF\xED\x03\x02\x02\x02\xEF\xF0\x03\x02" +
		"\x02\x02\xF0\xF3\x03\x02\x02\x02\xF1\xEF\x03\x02\x02\x02\xF2\xF4\x07\x19" +
		"\x02\x02\xF3\xF2\x03\x02\x02\x02\xF3\xF4\x03\x02\x02\x02\xF4\xF6\x03\x02" +
		"\x02\x02\xF5\xEA\x03\x02\x02\x02\xF5\xF6\x03\x02\x02\x02\xF6\xF7\x03\x02" +
		"\x02\x02\xF7\u0100\x07\x06\x02\x02\xF8\xF9\f\v\x02\x02\xF9\u0100\x07\x1D" +
		"\x02\x02\xFA\xFB\f\n\x02\x02\xFB\xFC\x07\x1A\x02\x02\xFC\u0100\x07\"\x02" +
		"\x02\xFD\xFE\f\t\x02\x02\xFE\u0100\x05\x18\r\x02\xFF\xD5\x03\x02\x02\x02" +
		"\xFF\xD8\x03\x02\x02\x02\xFF\xE8\x03\x02\x02\x02\xFF\xF8\x03\x02\x02\x02" +
		"\xFF\xFA\x03\x02\x02\x02\xFF\xFD\x03\x02\x02\x02\u0100\u0103\x03\x02\x02" +
		"\x02\u0101\xFF\x03\x02\x02\x02\u0101\u0102\x03\x02\x02\x02\u0102\v\x03" +
		"\x02\x02\x02\u0103\u0101\x03\x02\x02\x02\u0104\u0108\x07\x1F\x02\x02\u0105" +
		"\u0108\x07\x1E\x02\x02\u0106\u0108\x07 \x02\x02\u0107\u0104\x03\x02\x02" +
		"\x02\u0107\u0105\x03\x02\x02\x02\u0107\u0106\x03\x02\x02\x02\u0108\r\x03" +
		"\x02\x02\x02\u0109\u010A\x07\x17\x02\x02\u010A\u0115\x05\b\x05\x02\u010B" +
		"\u010C\x07$\x02\x02\u010C\u010F\x07\x03\x02\x02\u010D\u0110\x05\b\x05" +
		"\x02\u010E\u0110\x07$\x02\x02\u010F\u010D\x03\x02\x02\x02\u010F\u010E" +
		"\x03\x02\x02\x02\u0110\u0111\x03\x02\x02\x02\u0111\u010F\x03\x02\x02\x02" +
		"\u0111\u0112\x03\x02\x02\x02\u0112\u0113\x03\x02\x02\x02\u0113\u0115\x07" +
		"\x04\x02\x02\u0114\u0109\x03\x02\x02\x02\u0114\u010B\x03\x02\x02\x02\u0115" +
		"\x0F\x03\x02\x02\x02\u0116\u0117\x05\n\x06\x02\u0117\u0118\x07\x18\x02" +
		"\x02\u0118\u011A\x03\x02\x02\x02\u0119\u0116\x03\x02\x02\x02\u0119\u011A" +
		"\x03\x02\x02\x02\u011A\u011B\x03\x02\x02\x02\u011B\u011C\x05\n\x06\x02" +
		"\u011C\x11\x03\x02\x02\x02\u011D\u0123\x07\"\x02\x02\u011E\u011F\x05\n" +
		"\x06\x02\u011F\u0120\x05\x0E\b\x02\u0120\u0124\x03\x02\x02\x02\u0121\u0124" +
		"\x05\n\x06\x02\u0122\u0124\x05\x0E\b\x02\u0123\u011E\x03\x02\x02\x02\u0123" +
		"\u0121\x03\x02\x02\x02\u0123\u0122\x03\x02\x02\x02\u0123\u0124\x03\x02" +
		"\x02\x02\u0124\x13\x03\x02\x02\x02\u0125\u0131\x07\x07\x02\x02\u0126\u012B" +
		"\x05\x12\n\x02\u0127\u0128\x07\x19\x02\x02\u0128\u012A\x05\x12\n\x02\u0129" +
		"\u0127\x03\x02\x02\x02\u012A\u012D\x03\x02\x02\x02\u012B\u0129\x03\x02" +
		"\x02\x02\u012B\u012C\x03\x02\x02\x02\u012C\u012F\x03\x02\x02\x02\u012D" +
		"\u012B\x03\x02\x02\x02\u012E\u0130\x07\x19\x02\x02\u012F\u012E\x03\x02" +
		"\x02\x02\u012F\u0130\x03\x02\x02\x02\u0130\u0132\x03\x02\x02\x02\u0131" +
		"\u0126\x03\x02\x02\x02\u0131\u0132\x03\x02\x02\x02\u0132\u0133\x03\x02" +
		"\x02\x02\u0133\u0134\x07\b\x02\x02\u0134\x15\x03\x02\x02\x02\u0135\u0141" +
		"\x07\x05\x02\x02\u0136\u013B\x05\x12\n\x02\u0137\u0138\x07\x19\x02\x02" +
		"\u0138\u013A\x05\x12\n\x02\u0139\u0137\x03\x02\x02\x02\u013A\u013D\x03" +
		"\x02\x02\x02\u013B\u0139\x03\x02\x02\x02\u013B\u013C\x03\x02\x02\x02\u013C" +
		"\u013F\x03\x02\x02\x02\u013D\u013B\x03\x02\x02\x02\u013E\u0140\x07\x19" +
		"\x02\x02\u013F\u013E\x03\x02\x02\x02\u013F\u0140\x03\x02\x02\x02\u0140" +
		"\u0142\x03\x02\x02\x02\u0141\u0136\x03\x02\x02\x02\u0141\u0142\x03\x02" +
		"\x02\x02\u0142\u0143\x03\x02\x02\x02\u0143\u0144\x07\x06\x02\x02\u0144" +
		"\x17\x03\x02\x02\x02\u0145\u0146\x07\x1B\x02\x02\u0146\u014B\x05\x12\n" +
		"\x02\u0147\u0148\x07\x19\x02\x02\u0148\u014A\x05\x12\n\x02\u0149\u0147" +
		"\x03\x02\x02\x02\u014A\u014D\x03\x02\x02\x02\u014B\u0149\x03\x02\x02\x02" +
		"\u014B\u014C\x03\x02\x02\x02\u014C\u014F\x03\x02\x02\x02\u014D\u014B\x03" +
		"\x02\x02\x02\u014E\u0150\x07\x19\x02\x02\u014F\u014E\x03\x02\x02\x02\u014F" +
		"\u0150\x03\x02\x02\x02\u0150\u0151\x03\x02\x02\x02\u0151\u0152\x07\x1C" +
		"\x02\x02\u0152\x19\x03\x02\x02\x02<\x1D\x1F%(+136;?BFILOQ[_aim\x80\x86" +
		"\x8D\x97\xA1\xA5\xA7\xB0\xB4\xB6\xBE\xC2\xC7\xCB\xD3\xDF\xE3\xE5\xEF\xF3" +
		"\xF5\xFF\u0101\u0107\u010F\u0111\u0114\u0119\u0123\u012B\u012F\u0131\u013B" +
		"\u013F\u0141\u014B\u014F";
