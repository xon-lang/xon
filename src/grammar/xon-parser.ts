...
export class XonParser extends Parser {
	...
	public source(): SourceContext {
		...
		try {
			...
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << XonParser.OPEN_BRACKET) | (1 << XonParser.OPEN_PAREN) | (1 << XonParser.OPEN_BRACE) | (1 << XonParser.ACTUAL) | (1 << XonParser.BREAK) | (1 << XonParser.DO) | (1 << XonParser.EXPORT) | (1 << XonParser.FOR) | (1 << XonParser.IF) | (1 << XonParser.IMPORT) | (1 << XonParser.MODEL) | (1 << XonParser.OBJECT) | (1 << XonParser.RETURN) | (1 << XonParser.WHILE))) !== 0) || ((((_la - 41)) & ~0x1F) === 0 && ((1 << (_la - 41)) & ((1 << (XonParser.FLOAT_LITERAL - 41)) | (1 << (XonParser.INTEGER_LITERAL - 41)) | (1 << (XonParser.REGEX_LITERAL - 41)) | (1 << (XonParser.STRING_LITERAL - 41)) | (1 << (XonParser.PREPROCESSOR - 41)) | (1 << (XonParser.ID - 41)) | (1 << (XonParser.OPERATOR - 41)) | (1 << (XonParser.NL - 41)))) !== 0)) {
				{
				this.state = 24;
				this._errHandler.sync(this);
		...
		try {
			...
			case 12:
				...
				case 1:
					...
					this._errHandler.sync(this);
					_la = this._input.LA(1);
					if (((((_la - 24)) & ~0x1F) === 0 && ((1 << (_la - 24)) & ((1 << (XonParser.INFIX - 24)) | (1 << (XonParser.PREFIX - 24)) | (1 << (XonParser.ID - 24)) | (1 << (XonParser.OPERATOR - 24)))) !== 0)) {
						{
						this.state = 103;
						this.parameters();
						}
	...
	public expr(_p?: number): ExprContext {
		...
		try {
			...
			case 2:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << XonParser.OPEN_BRACKET) | (1 << XonParser.OPEN_PAREN) | (1 << XonParser.OPEN_BRACE))) !== 0) || ((((_la - 41)) & ~0x1F) === 0 && ((1 << (_la - 41)) & ((1 << (XonParser.FLOAT_LITERAL - 41)) | (1 << (XonParser.INTEGER_LITERAL - 41)) | (1 << (XonParser.REGEX_LITERAL - 41)) | (1 << (XonParser.STRING_LITERAL - 41)) | (1 << (XonParser.ID - 41)) | (1 << (XonParser.OPERATOR - 41)))) !== 0)) {
					{
					this.state = 125;
					this.arrayItem();
					this.state = 130;
	...
	public definitionBody(): DefinitionBodyContext {
		...
		try {
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (((((_la - 24)) & ~0x1F) === 0 && ((1 << (_la - 24)) & ((1 << (XonParser.INFIX - 24)) | (1 << (XonParser.PREFIX - 24)) | (1 << (XonParser.ID - 24)) | (1 << (XonParser.OPERATOR - 24)) | (1 << (XonParser.NL - 24)))) !== 0));
			this.state = 270;
			this.match(XonParser.DEDENT);
			}
		}
	...
	public parameter(): ParameterContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (_la === XonParser.INFIX || _la === XonParser.PREFIX) {
				{
				this.state = 290;
				_la = this._input.LA(1);
				if (!(_la === XonParser.INFIX || _la === XonParser.PREFIX)) {
			...
			case XonParser.OPERATOR:
				{
				this.state = 294;
				_localctx._op = this.match(XonParser.OPERATOR);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static readonly _serializedATN: string =
		...
		"\x03X\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x05\x03" +
		...
		"\x03\x04\x03\x04\x03\x04\x03\x04\x03\x04\x07\x04\x83\n\x04\f\x04\x0E\x04" +
		"\x86\v\x04\x03\x04\x05\x04\x89\n\x04\x05\x04\x8B\n\x04\x03\x04\x03\x04" +
		"\x03\x04\x03\x04\x03\x04\x07\x04\x92\n\x04\f\x04\x0E\x04\x95\v\x04\x03" +
		"\x04\x05\x04\x98\n\x04\x05\x04\x9A\n\x04\x03\x04\x03\x04\x03\x04\x03\x04" +
		"\x03\x04\x03\x04\x03\x04\x03\x04\x07\x04\xA4\n\x04\f\x04\x0E\x04\xA7\v" +
		"\x04\x03\x04\x05\x04\xAA\n\x04\x05\x04\xAC\n\x04\x03\x04\x03\x04\x03\x04" +
		"\x03\x04\x03\x04\x03\x04\x07\x04\xB4\n\x04\f\x04\x0E\x04\xB7\v\x04\x03" +
		"\x04\x05\x04\xBA\n\x04\x05\x04\xBC\n\x04\x03\x04\x03\x04\x03\x04\x03\x04" +
		"\x03\x04\x03\x04\x05\x04\xC4\n\x04\x03\x04\x03\x04\x03\x04\x03\x04\x03" +
		...
		"\x03\x05\x03\x05\x05\x05\xF7\n\x05\x03\x06\x03\x06\x03\x06\x05\x06\xFC" +
		"\n\x06\x03\x06\x03\x06\x03\x06\x03\x06\x06\x06\u0102\n\x06\r\x06\x0E\x06" +
		"\u0103\x03\x06\x05\x06\u0107\n\x06\x03\x07\x03\x07\x03\x07\x03\x07\x06" +
		"\x07\u010D\n\x07\r\x07\x0E\x07\u010E\x03\x07\x03\x07\x03\b\x03\b\x03\b" +
		"\x05\b\u0116\n\b\x03\b\x03\b\x03\t\x03\t\x03\t\x07\t\u011D\n\t\f\t\x0E" +
		"\t\u0120\v\t\x03\t\x05\t\u0123\n\t\x03\n\x05\n\u0126\n\n\x03\n\x03\n\x05" +
		"\n\u012A\n\n\x03\n\x03\n\x03\n\x03\n\x03\n\x05\n\u0131\n\n\x03\v\x03\v" +
		"\x03\f\x03\f\x03\f\x03\f\x03\f\x07\f\u013A\n\f\f\f\x0E\f\u013D\v\f\x03" +
		"\f\x05\f\u0140\n\f\x03\f\x03\f\x05\f\u0144\n\f\x03\f\x02\x02\x03\x06\r" +
		"\x02\x02\x04\x02\x06\x02\b\x02\n\x02\f\x02\x0E\x02\x10\x02\x12\x02\x14" +
		"\x02\x16\x02\x02\x05\x03\x0201\x04\x02\x1A\x1A\x1E\x1E\x06\x02\x0E\x0E" +
		"\x11\x11\x1B\x1C  \x02\u0189\x02\x1C\x03\x02\x02\x02\x04z\x03\x02\x02" +
		"\x02\x06\xC3\x03\x02\x02\x02\b\xF6\x03\x02\x02\x02\n\u0106\x03\x02\x02" +
		"\x02\f\u0108\x03\x02\x02\x02\x0E\u0115\x03\x02\x02\x02\x10\u0119\x03\x02" +
		"\x02\x02\x12\u0125\x03\x02\x02\x02\x14\u0132\x03\x02\x02\x02\x16\u0134" +
		"\x03\x02\x02\x02\x18\x1B\x05\x04\x03\x02\x19\x1B\x072\x02\x02\x1A\x18" +
		"\x03\x02\x02\x02\x1A\x19\x03\x02\x02\x02\x1B\x1E\x03\x02\x02\x02\x1C\x1A" +
		"\x03\x02\x02\x02\x1C\x1D\x03\x02\x02\x02\x1D\x03\x03\x02\x02\x02\x1E\x1C" +
		"\x03\x02\x02\x02\x1F \x07\x19\x02\x02 -\x05\x06\x04\x02!\"\x07#\x02\x02" +
		...
		"\x02/0\x07\x13\x02\x020{\x05\x06\x04\x0219\x07\x16\x02\x0225\x05\x12\n" +
		"\x0234\x07$\x02\x0246\x05\x12\n\x0253\x03\x02\x02\x0256\x03\x02\x02\x02" +
		"67\x03\x02\x02\x0278\x07\x18\x02\x028:\x03\x02\x02\x0292\x03\x02\x02\x02" +
		"9:\x03\x02\x02\x02:;\x03\x02\x02\x02;<\x05\x06\x04\x02<=\x05\n\x06\x02" +
		"={\x03\x02\x02\x02>?\x07!\x02\x02?@\x05\x06\x04\x02@A\x05\n\x06\x02A{" +
		"\x03\x02\x02\x02BC\x07\x0F\x02\x02CD\x05\n\x06\x02DE\x07!\x02\x02EF\x05" +
		"\x06\x04\x02F{\x03\x02\x02\x02GH\x07\x17\x02\x02HI\x05\x06\x04\x02IL\x05" +
		"\n\x06\x02JK\x07\x10\x02\x02KM\x05\n\x06\x02LJ\x03\x02\x02\x02LM\x03\x02" +
		"\x02\x02M{\x03\x02\x02\x02N{\x07\r\x02\x02OQ\x07\x1F\x02\x02PR\x05\x06" +
		"\x04\x02QP\x03\x02\x02\x02QR\x03\x02\x02\x02R{\x03\x02\x02\x02ST\x07\f" +
		"\x02\x02TV\x05\x06\x04\x02UW\x072\x02\x02VU\x03\x02\x02\x02WX\x03\x02" +
		"\x02\x02XV\x03\x02\x02\x02XY\x03\x02\x02\x02YZ\x03\x02\x02\x02Z[\x07\x12" +
		"\x02\x02[\\\x05\x06\x04\x02\\{\x03\x02\x02\x02]{\x07/\x02\x02^_\x07\x1B" +
		"\x02\x02_a\x05\x16\f\x02`b\x05\x16\f\x02a`\x03\x02\x02\x02ab\x03\x02\x02" +
		"\x02bd\x03\x02\x02\x02ce\x05\f\x07\x02dc\x03\x02\x02\x02de\x03\x02\x02" +
		"\x02e{\x03\x02\x02\x02fg\x07\x1C\x02\x02gm\x05\x16\f\x02hj\x07\x07\x02" +
		"\x02ik\x05\x10\t\x02ji\x03\x02\x02\x02jk\x03\x02\x02\x02kl\x03\x02\x02" +
		"\x02ln\x07\b\x02\x02mh\x03\x02\x02\x02mn\x03\x02\x02\x02np\x03\x02\x02" +
		"\x02oq\x05\x16\f\x02po\x03\x02\x02\x02pq\x03\x02\x02\x02qs\x03\x02\x02" +
		"\x02rt\x05\f\x07\x02sr\x03\x02\x02\x02st\x03\x02\x02\x02t{\x03\x02\x02" +
		"\x02uv\x05\x16\f\x02vw\x07\"\x02\x02wx\x05\x06\x04\x02x{\x03\x02\x02\x02" +
		"y{\x05\x06\x04\x02z\x1F\x03\x02\x02\x02z/\x03\x02\x02\x02z1\x03\x02\x02" +
		"\x02z>\x03\x02\x02\x02zB\x03\x02\x02\x02zG\x03\x02\x02\x02zN\x03\x02\x02" +
		"\x02zO\x03\x02\x02\x02zS\x03\x02\x02\x02z]\x03\x02\x02\x02z^\x03\x02\x02" +
		"\x02zf\x03\x02\x02\x02zu\x03\x02\x02\x02zy\x03\x02\x02\x02{\x05\x03\x02" +
		"\x02\x02|}\b\x04\x01\x02}\xC4\x05\x16\f\x02~\x8A\x07\x05\x02\x02\x7F\x84" +
		"\x05\x0E\b\x02\x80\x81\x07$\x02\x02\x81\x83\x05\x0E\b\x02\x82\x80\x03" +
		"\x02\x02\x02\x83\x86\x03\x02\x02\x02\x84\x82\x03\x02\x02\x02\x84\x85\x03" +
		"\x02\x02\x02\x85\x88\x03\x02\x02\x02\x86\x84\x03\x02\x02\x02\x87\x89\x07" +
		"$\x02\x02\x88\x87\x03\x02\x02\x02\x88\x89\x03\x02\x02\x02\x89\x8B\x03" +
		"\x02\x02\x02\x8A\x7F\x03\x02\x02\x02\x8A\x8B\x03\x02\x02\x02\x8B\x8C\x03" +
		"\x02\x02\x02\x8C\xC4\x07\x06\x02\x02\x8D\x99\x07\t\x02\x02\x8E\x93\x05" +
		"\x12\n\x02\x8F\x90\x07$\x02\x02\x90\x92\x05\x12\n\x02\x91\x8F\x03\x02" +
		"\x02\x02\x92\x95\x03\x02\x02\x02\x93\x91\x03\x02\x02\x02\x93\x94\x03\x02" +
		"\x02\x02\x94\x97\x03\x02\x02\x02\x95\x93\x03\x02\x02\x02\x96\x98\x07$" +
		"\x02\x02\x97\x96\x03\x02\x02\x02\x97\x98\x03\x02\x02\x02\x98\x9A\x03\x02" +
		"\x02\x02\x99\x8E\x03\x02\x02\x02\x99\x9A\x03\x02\x02\x02\x9A\x9B\x03\x02" +
		"\x02\x02\x9B\xC4\x07\n\x02\x02\x9C\x9D\t\x02\x02\x02\x9D\xC4\x05\x06\x04" +
		"\b\x9E\xC4\x05\b\x05\x02\x9F\xAB\x07\x07\x02\x02\xA0\xA5\x05\x12\n\x02" +
		"\xA1\xA2\x07$\x02\x02\xA2\xA4\x05\x12\n\x02\xA3\xA1\x03\x02\x02\x02\xA4" +
		...
		"\xAE\x07\b\x02\x02\xAE\xC4\x05\x06\x04\x05\xAF\xBB\x07\x05\x02\x02\xB0" +
		"\xB5\x05\x12\n\x02\xB1\xB2\x07$\x02\x02\xB2\xB4\x05\x12\n\x02\xB3\xB1" +
		...
		"\x07$\x02\x02\xB9\xB8\x03\x02\x02\x02\xB9\xBA\x03\x02\x02\x02\xBA\xBC" +
		"\x03\x02\x02\x02\xBB\xB0\x03\x02\x02\x02\xBB\xBC\x03\x02\x02\x02\xBC\xBD" +
		"\x03\x02\x02\x02\xBD\xBE\x07\x06\x02\x02\xBE\xC4\x05\x06\x04\x04\xBF\xC0" +
		"\x07\x07\x02\x02\xC0\xC1\x05\x06\x04\x02\xC1\xC2\x07\b\x02\x02\xC2\xC4" +
		"\x03\x02\x02\x02\xC3|\x03\x02\x02\x02\xC3~\x03\x02\x02\x02\xC3\x8D\x03" +
		"\x02\x02\x02\xC3\x9C\x03\x02\x02\x02\xC3\x9E\x03\x02\x02\x02\xC3\x9F\x03" +
		"\x02\x02\x02\xC3\xAF\x03\x02\x02\x02\xC3\xBF\x03\x02\x02\x02\xC4\xEF\x03" +
		"\x02\x02\x02\xC5\xC6\f\x07\x02\x02\xC6\xC7\t\x02\x02\x02\xC7\xEE\x05\x06" +
		"\x04\b\xC8\xC9\f\f\x02\x02\xC9\xD5\x07\x07\x02\x02\xCA\xCF\x05\x06\x04" +
		"\x02\xCB\xCC\x07$\x02\x02\xCC\xCE\x05\x06\x04\x02\xCD\xCB\x03\x02\x02" +
		"\x02\xCE\xD1\x03\x02\x02\x02\xCF\xCD\x03\x02\x02\x02\xCF\xD0\x03\x02\x02" +
		"\x02\xD0\xD3\x03\x02\x02\x02\xD1\xCF\x03\x02\x02\x02\xD2\xD4\x07$\x02" +
		"\x02\xD3\xD2\x03\x02\x02\x02\xD3\xD4\x03\x02\x02\x02\xD4\xD6\x03\x02\x02" +
		"\x02\xD5\xCA\x03\x02\x02\x02\xD5\xD6\x03\x02\x02\x02\xD6\xD7\x03\x02\x02" +
		"\x02\xD7\xEE\x07\b\x02\x02\xD8\xD9\f\v\x02\x02\xD9\xE5\x07\x05\x02\x02" +
		"\xDA\xDF\x05\x06\x04\x02\xDB\xDC\x07$\x02\x02\xDC\xDE\x05\x06\x04\x02" +
		"\xDD\xDB\x03\x02\x02\x02\xDE\xE1\x03\x02\x02\x02\xDF\xDD\x03\x02\x02\x02" +
		"\xDF\xE0\x03\x02\x02\x02\xE0\xE3\x03\x02\x02\x02\xE1\xDF\x03\x02\x02\x02" +
		"\xE2\xE4\x07$\x02\x02\xE3\xE2\x03\x02\x02\x02\xE3\xE4\x03\x02\x02\x02" +
		"\xE4\xE6\x03\x02\x02\x02\xE5\xDA\x03\x02\x02\x02\xE5\xE6\x03\x02\x02\x02" +
		"\xE6\xE7\x03\x02\x02\x02\xE7\xEE\x07\x06\x02\x02\xE8\xE9\f\n\x02\x02\xE9" +
		"\xEE\x07(\x02\x02\xEA\xEB\f\t\x02\x02\xEB\xEC\x07%\x02\x02\xEC\xEE\x05" +
		"\x16\f\x02\xED\xC5\x03\x02\x02\x02\xED\xC8\x03\x02\x02\x02\xED\xD8\x03" +
		"\x02\x02\x02\xED\xE8\x03\x02\x02\x02\xED\xEA\x03\x02\x02\x02\xEE\xF1\x03" +
		"\x02\x02\x02\xEF\xED\x03\x02\x02\x02\xEF\xF0\x03\x02\x02\x02\xF0\x07\x03" +
		"\x02\x02\x02\xF1\xEF\x03\x02\x02\x02\xF2\xF7\x07,\x02\x02\xF3\xF7\x07" +
		"+\x02\x02\xF4\xF7\x07.\x02\x02\xF5\xF7\x07-\x02\x02\xF6\xF2\x03\x02\x02" +
		"\x02\xF6\xF3\x03\x02\x02\x02\xF6\xF4\x03\x02\x02\x02\xF6\xF5\x03\x02\x02" +
		"\x02\xF7\t\x03\x02\x02\x02\xF8\xF9\x07#\x02\x02\xF9\u0107\x05\x04\x03" +
		"\x02\xFA\xFC\x07#\x02\x02\xFB\xFA\x03\x02\x02\x02\xFB\xFC\x03\x02\x02" +
		"\x02\xFC\xFD\x03\x02\x02\x02\xFD\xFE\x072\x02\x02\xFE\u0101\x07\x03\x02" +
		"\x02\xFF\u0102\x05\x04\x03\x02\u0100\u0102\x072\x02\x02\u0101\xFF\x03" +
		"\x02\x02\x02\u0101\u0100\x03\x02\x02\x02\u0102\u0103\x03\x02\x02\x02\u0103" +
		"\u0101\x03\x02\x02\x02\u0103\u0104\x03\x02\x02\x02\u0104\u0105\x03\x02" +
		"\x02\x02\u0105\u0107\x07\x04\x02\x02\u0106\xF8\x03\x02\x02\x02\u0106\xFB" +
		"\x03\x02\x02\x02\u0107\v\x03\x02\x02\x02\u0108\u0109\x072\x02\x02\u0109" +
		"\u010C\x07\x03\x02\x02\u010A\u010D\x05\x12\n\x02\u010B\u010D\x072\x02" +
		"\x02\u010C\u010A\x03\x02\x02\x02\u010C\u010B\x03\x02\x02\x02\u010D\u010E" +
		"\x03\x02\x02\x02\u010E\u010C\x03\x02\x02\x02\u010E\u010F\x03\x02\x02\x02" +
		"\u010F\u0110\x03\x02\x02\x02\u0110\u0111\x07\x04\x02\x02\u0111\r\x03\x02" +
		"\x02\x02\u0112\u0113\x05\x06\x04\x02\u0113\u0114\x07#\x02\x02\u0114\u0116" +
		"\x03\x02\x02\x02\u0115\u0112\x03\x02\x02\x02\u0115\u0116\x03\x02\x02\x02" +
		"\u0116\u0117\x03\x02\x02\x02\u0117\u0118\x05\x06\x04\x02\u0118\x0F\x03" +
		"\x02\x02\x02\u0119\u011E\x05\x12\n\x02\u011A\u011B\x07$\x02\x02\u011B" +
		"\u011D\x05\x12\n\x02\u011C\u011A\x03\x02\x02\x02\u011D\u0120\x03\x02\x02" +
		"\x02\u011E\u011C\x03\x02\x02\x02\u011E\u011F\x03\x02\x02\x02\u011F\u0122" +
		"\x03\x02\x02\x02\u0120\u011E\x03\x02\x02\x02\u0121\u0123\x07$\x02\x02" +
		"\u0122\u0121\x03\x02\x02\x02\u0122\u0123\x03\x02\x02\x02\u0123\x11\x03" +
		"\x02\x02\x02\u0124\u0126\t\x03\x02\x02\u0125\u0124\x03\x02\x02\x02\u0125" +
		"\u0126\x03\x02\x02\x02\u0126\u0129\x03\x02\x02\x02\u0127\u012A\x05\x16" +
		"\f\x02\u0128\u012A\x071\x02\x02\u0129\u0127\x03\x02\x02\x02\u0129\u0128" +
		"\x03\x02\x02\x02\u012A\u0130\x03\x02\x02\x02\u012B\u012C\x05\x06\x04\x02" +
		"\u012C\u012D\x05\n\x06\x02\u012D\u0131\x03\x02\x02\x02\u012E\u0131\x05" +
		"\x06\x04\x02\u012F\u0131\x05\n\x06\x02\u0130\u012B\x03\x02\x02\x02\u0130" +
		"\u012E\x03\x02\x02\x02\u0130\u012F\x03\x02\x02\x02\u0130\u0131\x03\x02" +
		"\x02\x02\u0131\x13\x03\x02\x02\x02\u0132\u0133\t\x04\x02\x02\u0133\x15" +
		"\x03\x02\x02\x02\u0134\u0143\x070\x02\x02\u0135\u0136\x07)\x02\x02\u0136" +
		"\u013B\x05\x12\n\x02\u0137\u0138\x07$\x02\x02\u0138\u013A\x05\x12\n\x02" +
		"\u0139\u0137\x03\x02\x02\x02\u013A\u013D\x03\x02\x02\x02\u013B\u0139\x03" +
		"\x02\x02\x02\u013B\u013C\x03\x02\x02\x02\u013C\u013F\x03\x02\x02\x02\u013D" +
		"\u013B\x03\x02\x02\x02\u013E\u0140\x07$\x02\x02\u013F\u013E\x03\x02\x02" +
		"\x02\u013F\u0140\x03\x02\x02\x02\u0140\u0141\x03\x02\x02\x02\u0141\u0142" +
		"\x07*\x02\x02\u0142\u0144\x03\x02\x02\x02\u0143\u0135\x03\x02\x02\x02" +
		"\u0143\u0144\x03\x02\x02\x02\u0144\x17\x03\x02\x02\x028\x1A\x1C\'+-59" +
		"LQXadjmpsz\x84\x88\x8A\x93\x97\x99\xA5\xA9\xAB\xB5\xB9\xBB\xC3\xCF\xD3" +
		"\xD5\xDF\xE3\xE5\xED\xEF\xF6\xFB\u0101\u0103\u0106\u010C\u010E\u0115\u011E" +
		"\u0122\u0125\u0129\u0130\u013B\u013F\u0143";
