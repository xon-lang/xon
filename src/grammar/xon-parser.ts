...
export class XonParser extends Parser {
	...
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		...
		"COLON", "QUESTION", "DOT", "LAMBDA", "FLOAT_LITERAL", "INTEGER_LITERAL", 
	...
	public source(): SourceContext {
		...
		try {
			...
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << XonParser.OPEN_BRACKET) | (1 << XonParser.OPEN_PAREN) | (1 << XonParser.OPEN_BRACE) | (1 << XonParser.ACTUAL) | (1 << XonParser.BREAK) | (1 << XonParser.CONTINUE) | (1 << XonParser.DO) | (1 << XonParser.EXPORT) | (1 << XonParser.FOR) | (1 << XonParser.IF) | (1 << XonParser.IMPORT) | (1 << XonParser.RETURN) | (1 << XonParser.WHILE) | (1 << XonParser.MODEL) | (1 << XonParser.OBJECT) | (1 << XonParser.FACTORY))) !== 0) || ((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (XonParser.FLOAT_LITERAL - 34)) | (1 << (XonParser.INTEGER_LITERAL - 34)) | (1 << (XonParser.STRING_LITERAL - 34)) | (1 << (XonParser.PREPROCESSOR - 34)) | (1 << (XonParser.ID - 34)) | (1 << (XonParser.OP - 34)) | (1 << (XonParser.NL - 34)))) !== 0)) {
				{
				this.state = 22;
				this._errHandler.sync(this);
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						_la = this._input.LA(1);
						if (!(((((_la - 24)) & ~0x1F) === 0 && ((1 << (_la - 24)) & ((1 << (XonParser.AND - 24)) | (1 << (XonParser.AS - 24)) | (1 << (XonParser.IS - 24)) | (1 << (XonParser.OR - 24)) | (1 << (XonParser.OP - 24)))) !== 0))) {
	...
	public definition(): DefinitionContext {
		...
		try {
			...
			_la = this._input.LA(1);
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << XonParser.MODEL) | (1 << XonParser.OBJECT) | (1 << XonParser.FACTORY))) !== 0))) {
		...
		try {
			...
			case 2:
				...
				if (_la === XonParser.COLON) {
					...
					this._errHandler.sync(this);
					_la = this._input.LA(1);
					if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << XonParser.OPEN_BRACKET) | (1 << XonParser.OPEN_PAREN) | (1 << XonParser.OPEN_BRACE) | (1 << XonParser.IMPORT))) !== 0) || ((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (XonParser.FLOAT_LITERAL - 34)) | (1 << (XonParser.INTEGER_LITERAL - 34)) | (1 << (XonParser.STRING_LITERAL - 34)) | (1 << (XonParser.PREPROCESSOR - 34)) | (1 << (XonParser.ID - 34)) | (1 << (XonParser.OP - 34)))) !== 0)) {
						{
						this.state = 157;
						_localctx._type = this.expression(0);
						}
	...
	public static readonly _serializedATN: string =
		...
		"\x12\x02\x14\x02\x02\x07\x04\x02\x14\x14))\x04\x02\x1A\x1D))\x03\x02\x17" +
		"\x19\x05\x02\x05\x05\x07\x07\t\t\x05\x02\x06\x06\b\b\n\n\x02\u011E\x02" +
		"\x1A\x03\x02\x02\x02\x04W\x03\x02\x02\x02\x06h\x03\x02\x02\x02\b|\x03" +
		"\x02\x02\x02\n~\x03\x02\x02\x02\f\xA7\x03\x02\x02\x02\x0E\xA9\x03\x02" +
		"\x02\x02\x10\xBB\x03\x02\x02\x02\x12\xBF\x03\x02\x02\x02\x14\xED\x03\x02" +
		"\x02\x02\x16\x19\x05\x04\x03\x02\x17\x19\x07*\x02\x02\x18\x16\x03\x02" +
		"\x02\x02\x18\x17\x03\x02\x02\x02\x19\x1C\x03\x02\x02\x02\x1A\x18\x03\x02" +
		"\x02\x02\x1A\x1B\x03\x02\x02\x02\x1B\x03\x03\x02\x02\x02\x1C\x1A\x03\x02" +
		"\x02\x02\x1DX\x05\n\x06\x02\x1E\x1F\x07(\x02\x02\x1F!\x07)\x02\x02 \"" +
		"\x05\x06\x04\x02! \x03\x02\x02\x02!\"\x03\x02\x02\x02\"$\x03\x02\x02\x02" +
		"#%\x05\x14\v\x02$#\x03\x02\x02\x02$%\x03\x02\x02\x02%X\x03\x02\x02\x02" +
		"&\'\x07\x11\x02\x02\'X\x05\x06\x04\x02(0\x07\x12\x02\x02),\x05\f\x07\x02" +
		"*+\x07\x1F\x02\x02+-\x05\f\x07\x02,*\x03\x02\x02\x02,-\x03\x02\x02\x02" +
		"-.\x03\x02\x02\x02./\x07(\x02\x02/1\x03\x02\x02\x020)\x03\x02\x02\x02" +
		"01\x03\x02\x02\x0212\x03\x02\x02\x0223\x05\x06\x04\x0234\x05\x14\v\x02" +
		"4X\x03\x02\x02\x0256\x07\x16\x02\x0267\x05\x06\x04\x0278\x05\x14\v\x02" +
		"8X\x03\x02\x02\x029:\x07\x0E\x02\x02:;\x05\x14\v\x02;<\x07\x16\x02\x02" +
		"<=\x05\x06\x04\x02=X\x03\x02\x02\x02>?\x07\x13\x02\x02?@\x05\x06\x04\x02" +
		"@C\x05\x14\v\x02AB\x07\x0F\x02\x02BD\x05\x14\v\x02CA\x03\x02\x02\x02C" +
		"D\x03\x02\x02\x02DX\x03\x02\x02\x02EX\x07\f\x02\x02FX\x07\r\x02\x02GI" +
		"\x07\x15\x02\x02HJ\x05\x06\x04\x02IH\x03\x02\x02\x02IJ\x03\x02\x02\x02" +
		"JX\x03\x02\x02\x02KL\x07\v\x02\x02LN\x05\x06\x04\x02MO\x07*\x02\x02NM" +
		"\x03\x02\x02\x02OP\x03\x02\x02\x02PN\x03\x02\x02\x02PQ\x03\x02\x02\x02" +
		"QR\x03\x02\x02\x02RS\x07\x10\x02\x02ST\x05\x06\x04\x02TX\x03\x02\x02\x02" +
		"UX\x05\f\x07\x02VX\x05\x06\x04\x02W\x1D\x03\x02\x02\x02W\x1E\x03\x02\x02" +
		"\x02W&\x03\x02\x02\x02W(\x03\x02\x02\x02W5\x03\x02\x02\x02W9\x03\x02\x02" +
		"\x02W>\x03\x02\x02\x02WE\x03\x02\x02\x02WF\x03\x02\x02\x02WG\x03\x02\x02" +
		"\x02WK\x03\x02\x02\x02WU\x03\x02\x02\x02WV\x03\x02\x02\x02X\x05\x03\x02" +
		"\x02\x02YZ\b\x04\x01\x02Zi\x07\'\x02\x02[\\\x07\x07\x02\x02\\]\x05\x06" +
		"\x04\x02]^\x07\b\x02\x02^i\x03\x02\x02\x02_i\x05\x12\n\x02`a\t\x02\x02" +
		"\x02ai\x05\x06\x04\x07bi\x07(\x02\x02cd\x05\x0E\b\x02de\x07#\x02\x02e" +
		"f\x05\x06\x04\x04fi\x03\x02\x02\x02gi\x05\b\x05\x02hY\x03\x02\x02\x02" +
		"h[\x03\x02\x02\x02h_\x03\x02\x02\x02h`\x03\x02\x02\x02hb\x03\x02\x02\x02" +
		"hc\x03\x02\x02\x02hg\x03\x02\x02\x02iv\x03\x02\x02\x02jk\f\x06\x02\x02" +
		"kl\t\x03\x02\x02lu\x05\x06\x04\x07mn\f\n\x02\x02nu\x07!\x02\x02op\f\t" +
		"\x02\x02pq\x07\"\x02\x02qu\x07(\x02\x02rs\f\b\x02\x02su\x05\x12\n\x02" +
		"tj\x03\x02\x02\x02tm\x03\x02\x02\x02to\x03\x02\x02\x02tr\x03\x02\x02\x02" +
		"ux\x03\x02\x02\x02vt\x03\x02\x02\x02vw\x03\x02\x02\x02w\x07\x03\x02\x02" +
		"\x02xv\x03\x02\x02\x02y}\x07%\x02\x02z}\x07$\x02\x02{}\x07&\x02\x02|y" +
		"\x03\x02\x02\x02|z\x03\x02\x02\x02|{\x03\x02\x02\x02}\t\x03\x02\x02\x02" +
		"~\x7F\t\x04\x02\x02\x7F\x81\x07(\x02\x02\x80\x82\x05\x0E\b\x02\x81\x80" +
		"\x03\x02\x02\x02\x81\x82\x03\x02\x02\x02\x82\x85\x03\x02\x02\x02\x83\x84" +
		"\x07\x1C\x02\x02\x84\x86\x05\x06\x04\x02\x85\x83\x03\x02\x02\x02\x85\x86" +
		"\x03\x02\x02\x02\x86\x90\x03\x02\x02\x02\x87\x88\x07*\x02\x02\x88\x8B" +
		"\x07\x03\x02\x02\x89\x8C\x05\f\x07\x02\x8A\x8C\x07*\x02\x02\x8B\x89\x03" +
		"\x02\x02\x02\x8B\x8A\x03\x02\x02\x02\x8C\x8D\x03\x02\x02\x02\x8D\x8B\x03" +
		"\x02\x02\x02\x8D\x8E\x03\x02\x02\x02\x8E\x8F\x03\x02\x02\x02\x8F\x91\x07" +
		"\x04\x02\x02\x90\x87\x03\x02\x02\x02\x90\x91\x03\x02\x02\x02\x91\v\x03" +
		"\x02\x02\x02\x92\x9B\x07(\x02\x02\x93\x95\x07 \x02\x02\x94\x96\x05\x06" +
		"\x04\x02\x95\x94\x03\x02\x02\x02\x95\x96\x03\x02\x02\x02\x96\x98\x03\x02" +
		"\x02\x02\x97\x99\x05\x14\v\x02\x98\x97\x03\x02\x02\x02\x98\x99\x03\x02" +
		"\x02\x02\x99\x9C\x03\x02\x02\x02\x9A\x9C\x05\x14\v\x02\x9B\x93\x03\x02" +
		"\x02\x02\x9B\x9A\x03\x02\x02\x02\x9C\xA8\x03\x02\x02\x02\x9D\xA2\x05\x0E" +
		"\b\x02\x9E\xA0\x07 \x02\x02\x9F\xA1\x05\x06\x04\x02\xA0\x9F\x03\x02\x02" +
		"\x02\xA0\xA1\x03\x02\x02\x02\xA1\xA3\x03\x02\x02\x02\xA2\x9E\x03\x02\x02" +
		"\x02\xA2\xA3\x03\x02\x02\x02\xA3\xA4\x03\x02\x02\x02\xA4\xA5\x05\x14\v" +
		"\x02\xA5\xA8\x03\x02\x02\x02\xA6\xA8\x07(\x02\x02\xA7\x92\x03\x02\x02" +
		"\x02\xA7\x9D\x03\x02\x02\x02\xA7\xA6\x03\x02\x02\x02\xA8\r\x03\x02\x02" +
		"\x02\xA9\xB5\t\x05\x02\x02\xAA\xAF\x05\f\x07\x02\xAB\xAC\x07\x1F\x02\x02" +
		"\xAC\xAE\x05\f\x07\x02\xAD\xAB\x03\x02\x02\x02\xAE\xB1\x03\x02\x02\x02" +
		"\xAF\xAD\x03\x02\x02\x02\xAF\xB0\x03\x02\x02\x02\xB0\xB3\x03\x02\x02\x02" +
		"\xB1\xAF\x03\x02\x02\x02\xB2\xB4\x07\x1F\x02\x02\xB3\xB2\x03\x02\x02\x02" +
		"\xB3\xB4\x03\x02\x02\x02\xB4\xB6\x03\x02\x02\x02\xB5\xAA\x03\x02\x02\x02" +
		"\xB5\xB6\x03\x02\x02\x02\xB6\xB7\x03\x02\x02\x02\xB7\xB8\t\x06\x02\x02" +
		"\xB8\x0F\x03\x02\x02\x02\xB9\xBA\x07(\x02\x02\xBA\xBC\x07 \x02\x02\xBB" +
		"\xB9\x03\x02\x02\x02\xBB\xBC\x03\x02\x02\x02\xBC\xBD\x03\x02\x02\x02\xBD" +
		"\xBE\x05\x06\x04\x02\xBE\x11\x03\x02\x02\x02\xBF\xCB\t\x05\x02\x02\xC0" +
		"\xC5\x05\x10\t\x02\xC1\xC2\x07\x1F\x02\x02\xC2\xC4\x05\x10\t\x02\xC3\xC1" +
		"\x03\x02\x02\x02\xC4\xC7\x03\x02\x02\x02\xC5\xC3\x03\x02\x02\x02\xC5\xC6" +
		"\x03\x02\x02\x02\xC6\xC9\x03\x02\x02\x02\xC7\xC5\x03\x02\x02\x02\xC8\xCA" +
		...
		"\x07*\x02\x02\xDB\xDA\x03\x02\x02\x02\xDC\xDD\x03\x02\x02\x02\xDD\xDB" +
		"\x03\x02\x02\x02\xDD\xDE\x03\x02\x02\x02\xDE\xDF\x03\x02\x02\x02\xDF\xE1" +
		"\x05\x04\x03\x02\xE0\xDB\x03\x02\x02\x02\xE1\xE4\x03\x02\x02\x02\xE2\xE0" +
		"\x03\x02\x02\x02\xE2\xE3\x03\x02\x02\x02\xE3\xE8\x03\x02\x02\x02\xE4\xE2" +
		"\x03\x02\x02\x02\xE5\xE7\x07*\x02\x02\xE6\xE5\x03\x02\x02\x02\xE7\xEA" +
		"\x03\x02\x02\x02\xE8\xE6\x03\x02\x02\x02\xE8\xE9\x03\x02\x02\x02\xE9\xEB" +
		"\x03\x02\x02\x02\xEA\xE8\x03\x02\x02\x02\xEB\xEC\x07\x04\x02\x02\xEC\xEE" +
		"\x03\x02\x02\x02\xED\xCF\x03\x02\x02\x02\xED\xD1\x03\x02\x02\x02\xEE\x15" +
		"\x03\x02\x02\x02\'\x18\x1A!$,0CIPWhtv|\x81\x85\x8B\x8D\x90\x95\x98\x9B" +
		"\xA0\xA2\xA7\xAF\xB3\xB5\xBB\xC5\xC9\xCB\xD6\xDD\xE2\xE8\xED";
...
export class DefinitionContext extends ParserRuleContext {
	...
	public FACTORY(): TerminalNode | undefined { return this.tryGetToken(XonParser.FACTORY, 0); }
