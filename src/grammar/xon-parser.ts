...
export class XonParser extends Parser {
	...
	public expression(_p?: number): ExpressionContext {
		...
		try {
			...
			case XonParser.OPEN:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << XonParser.OPEN) | (1 << XonParser.FLOAT) | (1 << XonParser.INTEGER) | (1 << XonParser.STRING) | (1 << XonParser.OPERATOR) | (1 << XonParser.COMMA) | (1 << XonParser.ID) | (1 << XonParser.NL) | (1 << XonParser.UNEXPECTED))) !== 0)) {
					{
					this.state = 35;
					this._errHandler.sync(this);
					switch (this._input.LA(1)) {
			...
			case XonParser.UNEXPECTED:
				{
				_localctx = new UnexpectedExpressionContext(_localctx);
				this._ctx = _localctx;
				_prevctx = _localctx;
				this.state = 42;
				this._errHandler.sync(this);
	...
	public static readonly _serializedATN: string =
		...
		"\x03\x02\x02\x03\x04\x04\x02\x02\x04\x02\x02\x02\x02F\x02\x07\x03\x02" +
		"\x02\x02\x040\x03\x02\x02\x02\x06\b\x07\r\x02\x02\x07\x06\x03\x02\x02" +
		"\x02\x07\b\x03\x02\x02\x02\b\x0E\x03\x02\x02\x02\t\n\x05\x04\x03\x02\n" +
		"\v\x07\r\x02\x02\v\r\x03\x02\x02\x02\f\t\x03\x02\x02\x02\r\x10\x03\x02" +
		"\x02\x02\x0E\f\x03\x02\x02\x02\x0E\x0F\x03\x02\x02\x02\x0F\x12\x03\x02" +
		"\x02\x02\x10\x0E\x03\x02\x02\x02\x11\x13\x05\x04\x03\x02\x12\x11\x03\x02" +
		"\x02\x02\x12\x13\x03\x02\x02\x02\x13\x15\x03\x02\x02\x02\x14\x16\x07\r" +
		"\x02\x02\x15\x14\x03\x02\x02\x02\x15\x16\x03\x02\x02\x02\x16\x03\x03\x02" +
		"\x02\x02\x17\x18\b\x03\x01\x02\x181\x07\f\x02\x02\x191\x07\n\x02\x02\x1A" +
		"1\x07\b\x02\x02\x1B1\x07\x07\x02\x02\x1C1\x07\t\x02\x02\x1D\x1E\x07\r" +
		"\x02\x02\x1E\x1F\x07\x03\x02\x02\x1F \x05\x02\x02\x02 !\x07\x04\x02\x02" +
		"!1\x03\x02\x02\x02\"\'\x07\x05\x02\x02#&\x05\x04\x03\x02$&\x07\v\x02\x02" +
		"%#\x03\x02\x02\x02%$\x03\x02\x02\x02&)\x03\x02\x02\x02\'%\x03\x02\x02" +
		"\x02\'(\x03\x02\x02\x02(*\x03\x02\x02\x02)\'\x03\x02\x02\x02*1\x07\x06" +
		"\x02\x02+-\x07\x12\x02\x02,+\x03\x02\x02\x02-.\x03\x02\x02\x02.,\x03\x02" +
		"\x02\x02./\x03\x02\x02\x02/1\x03\x02\x02\x020\x17\x03\x02\x02\x020\x19" +
		"\x03\x02\x02\x020\x1A\x03\x02\x02\x020\x1B\x03\x02\x02\x020\x1C\x03\x02" +
		"\x02\x020\x1D\x03\x02\x02\x020\"\x03\x02\x02\x020,\x03\x02\x02\x0216\x03" +
		"\x02\x02\x0223\f\x03\x02\x0235\x05\x04\x03\x0442\x03\x02\x02\x0258\x03" +
		"\x02\x02\x0264\x03\x02\x02\x0267\x03\x02\x02\x027\x05\x03\x02\x02\x02" +
		"86\x03\x02\x02\x02\v\x07\x0E\x12\x15%\'.06";
...
export class UnexpectedExpressionContext extends ExpressionContext {
