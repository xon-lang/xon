...
class BitNotExpressionTree extends expression_tree_1.ExpressionTree {
    constructor(ctx) {
        super();
        this.ctx = ctx;
...
exports.BitNotExpressionTree = BitNotExpressionTree;
//# sourceMappingURL=bit-not-expression.tree.js.map