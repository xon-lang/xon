...
class BitXorExpressionTree extends expression_tree_1.ExpressionTree {
    constructor(ctx) {
        super();
        this.ctx = ctx;
...
exports.BitXorExpressionTree = BitXorExpressionTree;
//# sourceMappingURL=bit-xor-expression.tree.js.map